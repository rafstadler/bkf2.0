    ...
    render() {
        return (
            <div>
                ...
                <div className='page'>
                <Container>
                    <h1 className='waw-h1' align='center'>BREAKFAST</h1>
                    <Row>
                    ...
                    <h1 className='waw-h1' align='center'>LES FONDATEURS</h1>
                        ...
                        <Col md={{ span: 4, offset: 1 }}>
                            <AnimatedOnScroll animationIn='fadeInUpBig' animationInDuration='1200' isVisible={true}>
                                <div className='waw-fondateur'>
                                    <h2 className='waw-h2'>  Ludovic Garni,</h2>membre fondateur du collectif créatif Breakfast Paris, est un artiste peintre s’inspirant du style impressionnisme et du réalisme afin de réaliser des <a href="/works#painting"><b className='waw-b'>tableaux</b></a> de paysages et d’autres de femmes : deux éléments primordiaux l’inspirant dans sa vie de tous les jours. Il est également gérant de la marque de <a href="/works#clothes"><b className='waw-b'>vêtements</b></a> Breakfast Paris en tant que Brand Manager mais aussi Art Director et Project Manager pour la mise en place des Breakfast Exhibitions.
                                </div>
                            </AnimatedOnScroll>
                        </Col>
                        <Col md={6}>
                    ...
                    <Row className="fondateur">
                        ...
                        <Col md={4}>
                            <AnimatedOnScroll animationIn='fadeInUpBig' animationInDuration='1200' isVisible={true}>
                                <div className='waw-fondateur'>
                                    <h2 className='waw-h2'>  Emota,</h2>membre fondateur de la marque Breakfast Paris, il est un artiste accompli en tant que <a href="/works#music"><b className='waw-b'>chanteur</b></a>, <a href="/works#painting"><b className='waw-b'>peintre</b></a> et <a href="/works#tattoo"><b className='waw-b'>tatoueur</b></a>. Il réalise des tableaux s’inscrivant dans le style cubisme tout en s’inspirant de masques africains, de forme géométrique qu’il retravaille à sa manière dans un mélange formant des personnages défigurés tout cela afin de créer son propre style. Emota puise son inspiration principalement dans la faune et la flore tout en les ralliant à la femme et à ses personnages aux masques africains.
                                </div>
                            </AnimatedOnScroll>
                        </Col>
                    ...
                    <Row className="fondateur">
                        <Col md={{ span: 4, offset: 1 }}>
                            <AnimatedOnScroll animationIn='fadeInUpBig' animationInDuration='1500' isVisible={true}>
                                <div className='waw-fondateur'>
                                    <h2 className='waw-h2'>  Tchap,</h2>membre fondateur du collectif créatif Breakfast Paris, est un <a href="/works#music"><b className='waw-b'>rappeur</b></a>, <a href="/works#danse"><b className='waw-b'>danseur</b></a>, event planner et commercial. Tout en participant au bon fonctionnement de la marque Breakfast Paris et de la mise en place des évènements avec Ludovic Garni, Tchap a récemment sorti des titres tels que Trouble, En Scène ou encore Replay.
                                </div>
                            </AnimatedOnScroll>
                        </Col>
                        <Col md={6}>
                    ...
                    <h1 className='waw-h1' align='center'>HISTORY</h1>
